...
#Canvas3
        ...
        def plotcor():
            ...
            db=pymysql.connect(host='localhost',user='root',password='Ritik@123',database='ERS')
            cur=db.cursor()
        ...
        #heading
        heading=Label(mid_canvas,text='Institute Insert',fg='green',bg='white',font=('arial',45,'bold'),width=45)
...
#Canvas4
        ...
        mid_canvas2.place(x=205,y=110)
        
        #heading
        heading=Label(mid_canvas2,text='Institute Update',fg='green',bg='white',font=('arial',45,'bold'),width=45)
        heading.place(x=-160,y=10)  
        def finddata():
            a=InstuteId.get()
            db=pymysql.connect(host='localhost',user='root',password='Ritik@123',database='ERS')
...
#Canvas5
        ...
        mid_canvas3.place(x=205,y=110)
        
        #heading
        heading=Label(mid_canvas3,text='Institute Find',fg='green',bg='white',font=('arial',45,'bold'),width=45)
        heading.place(x=-160,y=10)
...
#Canvas6
        ...
        mid_canvas4.place(x=205,y=110)
        
        #heading
        heading=Label(mid_canvas4,text='INSTUTE DELETE',fg='green',bg='white',font=('arial',45,'bold'),width=45)
        heading.place(x=-160,y=10)
        insidlist=[]
        def deletedata():
            a=InstuteId.get()
...
#Canvas7
        ...
        def plotcorcour():  
            ...
            db=pymysql.connect(host='localhost',user='root',password='Ritik@123',database='ERS')
            cur=db.cursor()
            sql="select cour_name,duration from course"
            a=[]
            b=[]
            cur.execute(sql)
            data=cur.fetchall()
            ...
            axes=figure.add_subplot()
            axes.bar(languages, Duration)
            axes.set_title('Name and Duration')
        ...
        #heading
        heading=Label(mid_canvas5,text='COURSE INSERT',fg='green',bg='white',font=('arial',45,'bold'),width=45)
        heading.place(x=-160,y=10)
        ...
        def savedata():
            ...
            if len(p)==0 or len(r)==0 or len(t)==0 or len(u)==0 or len(y)==0:
                ...
                sql="insert into course values('%s','%s','%s','%s','%s')"%(p,r,t,u,y)
                cur.execute(sql)
                messagebox.showinfo('Saved','Data Saved')
...
#Canvas8
        ...
        mid_canvas6.place(x=205,y=110)
        
        #heading
        heading=Label(mid_canvas6,text='COURSE UPDATE',fg='green',bg='white',font=('arial',45,'bold'),width=45)
        heading.place(x=-160,y=10)
        ...
        def finddata():
            ...
            if len(a)==0:
                ...
                sql="select*from course where cour_id='%s'"%(a) 
                cur.execute(sql)
                data=cur.fetchone()
                if data==None:
                    messagebox.showinfo('Not found','No found')
        ...
        def updatedata():
            ...
            if len(a)==0 or len(b)==0 or len(c)==0 or len(d)==0 or len(e)==0:
                ...
                sql="update course set cour_name='%s',duration='%s',fee='%s',description='%s' where cour_id='%s'" %(b,c,d,e,a)
                cur.execute(sql)
                messagebox.showinfo('Update','Update Done')
                db.commit()    
                db.close()
...
#Canvas9
        ...
        mid_canvas7.place(x=205,y=110)
        
        #heading
        heading=Label(mid_canvas7,text='COURSE FIND',fg='green',bg='white',font=('arial',45,'bold'),width=45)
        heading.place(x=-160,y=10)
...
#Canvas10
        ...
        mid_canvas8.place(x=205,y=110)
        
        #heading
        heading=Label(mid_canvas8,text='COURSE DELETE',fg='green',bg='white',font=('arial',45,'bold'),width=45)
        heading.place(x=-160,y=10)
        ...
        def deletedata():
            ...
            if len(a)==0:
                ...
                sql="delete from course where cour_id='%s'"%(a) 
                cur.execute(sql)
                messagebox.showinfo('Delete','Data Delete')
                db.commit()
                db.close()
...
#Canvas11
        ...
        mid_canvas9.place(x=205,y=110)
        
        #heading
        heading=Label(mid_canvas9,text='FEE INSERT',fg='green',bg='white',font=('arial',45,'bold'),width=45)
        heading.place(x=-160,y=10)
        def receipt():
        ...
        def savedata():
            ...
            if len(p)==0 or len(r)==0 or len(t)==0:
                ...
                sql="insert into feesplan values('%s','%s','%s')"%(p,r,t)
                cur.execute(sql)
                messagebox.showinfo('Saved','Data Saved')
                feeId.delete(0,100)
                amount.delete(0,100)
...
#Canvas12
        ...
        mid_canvas10.place(x=205,y=110)
        
        #heading
        heading=Label(mid_canvas10,text='FEE UPDATE',fg='green',bg='white',font=('arial',45,'bold'),width=45)
        heading.place(x=-160,y=10)
        ...
        def finddata():
            ...
            if len(a)==0:
                ...
                sql="select*from feesplan where feeplan_id='%s'"%(a) 
                cur.execute(sql)
                data=cur.fetchone()
                if data==None:
                    messagebox.showinfo('Not found','No found')
        ...
        def updatedata():
            ...
            if len(a)==0 or len(b)==0 or len(c)==0:
                ...
                sql="update feesplan set amount='%s',installment='%s' where feeplan_id='%s'" %(b,c,a)
                cur.execute(sql)
                messagebox.showinfo('Update','Update Done')
                db.commit()    
                db.close()
...
#Canvas13
        ...
        mid_canvas11.place(x=205,y=110)
        
        #heading
        heading=Label(mid_canvas11,text='FEE FIND',fg='green',bg='white',font=('arial',45,'bold'),width=45)
        heading.place(x=-160,y=10)
...
#Canvas14
        ...
        mid_canvas12.place(x=205,y=110)
        
        #heading
        heading=Label(mid_canvas12,text='FEE DELETE',fg='green',bg='white',font=('arial',45,'bold'),width=45)
        heading.place(x=-160,y=10)
        ...
        def deletedata():
            ...
            if len(a)==0:
                ...
                sql="delete from feesplan where feeplan_id='%s'"%(a) 
                cur.execute(sql)
                messagebox.showinfo('Delete','Data Delete')
                db.commit()
                db.close()
...
#Canvas15
        ...
        mid_canvas13.place(x=205,y=110)
        
        #heading
        heading=Label(mid_canvas13,text='ENQUIRY INSERT',fg='green',bg='white',font=('arial',45,'bold'),width=45)
        heading.place(x=-160,y=10)
...
#Canvas16
        ...
        mid_canvas14.place(x=205,y=110)
        
        #heading
        heading=Label(mid_canvas14,text='ENQUIRY UPDATE',fg='green',bg='white',font=('arial',45,'bold'),width=45)
        heading.place(x=-160,y=10)
        ...
        def finddata():
            ...
            if len(a)==0:
                ...
                sql="select*from enquiry where enqno='%s'"%(a) 
                cur.execute(sql)
                data=cur.fetchone()
                if data==None:
                    messagebox.showinfo('Not found','No found')
        ...
        def updatedata():
            ...
            if len(p)==0 or len(r)==0 or len(t)==0 or len(s)==0 or len(v)==0 or len(w)==0 or len(x)==0 or len(z)==0:
                ...
                sql="update enquiry set name='%s',address='%s',city='%s',email='%s',phone='%s',courseid='%s',dateofenquiry='%s' where enqno='%s'" %(r,t,s,v,w,x,z,p)
                cur.execute(sql)
                messagebox.showinfo('Update','Update Done')
                db.commit()    
                db.close()
...
#Canvas17
        ...
        mid_canvas15.place(x=205,y=110)
        
        #heading
        heading=Label(mid_canvas15,text='ENQUIRY FIND',fg='green',bg='white',font=('arial',45,'bold'),width=45)
        heading.place(x=-160,y=10)
...
#Canvas18
        ...
        mid_canvas16.place(x=205,y=110)
        
        #heading
        heading=Label(mid_canvas16,text='ENQUIRY DELETE',fg='green',bg='white',font=('arial',45,'bold'),width=45)
        heading.place(x=-160,y=10)
        ...
        def deletedata():
            ...
            if len(a)==0:
                ...
                sql="delete from enquiry where enqno='%s'"%(a) 
                cur.execute(sql)
                messagebox.showinfo('Delete','Data Delete')
                db.commit()
                db.close()
...
#Canvas19
        ...
        mid_canvas17.place(x=205,y=110)
        
        #heading
        heading=Label(mid_canvas17,text='BATCH INSERT',fg='green',bg='white',font=('arial',45,'bold'),width=45)
        heading.place(x=-160,y=10)
        ...
        def savedata():
            ...
            if len(p)==0 or len(r)==0 or len(t)==0 or len(s)==0:
                ...
                sql="insert into Batches values('%s','%s','%s','%s')"%(p,r,t,s)
                cur.execute(sql)
                messagebox.showinfo('Saved','Data Saved')
                batId.delete(0,100)
...
#Canvas20
        ...
        mid_canvas18.place(x=205,y=110)
        
        #heading
        heading=Label(mid_canvas18,text='BATCH UPDATE',fg='green',bg='white',font=('arial',45,'bold'),width=45)
        heading.place(x=-160,y=10)
        ...
        def finddata():
            ...
            if len(a)==0:
                ...
                sql="select*from Batches where Batch_id='%s'"%(a) 
                cur.execute(sql)
                data=cur.fetchone()
                if data==None:
                    messagebox.showinfo('Not found','No found')
        ...
        def updatedata():
            ...
            if len(p)==0 or len(r)==0 or len(t)==0 or len(s)==0:
                ...
                sql="update Batches set from_time='%s',to_time='%s',start_end='%s' where Batch_id='%s'" %(r,t,s,p)
                cur.execute(sql)
                messagebox.showinfo('Update','Update Done')
                db.commit()    
                db.close()
...
#Canvas21
        ...
        mid_canvas19.place(x=205,y=110)
        
        #heading
        heading=Label(mid_canvas19,text='BATCH FIND',fg='green',bg='white',font=('arial',45,'bold'),width=45)
        heading.place(x=-160,y=10)
...
#Canvas21
        ...
        mid_canvas20.place(x=205,y=110)
        
        #heading
        heading=Label(mid_canvas20,text='BATCH DELETE',fg='green',bg='white',font=('arial',45,'bold'),width=45)
        heading.place(x=-160,y=10)
        ...
        def deletedata():
            ...
            if len(a)==0:
                ...
                sql="delete from Batches where Batch_id='%s'"%(a) 
                cur.execute(sql)
                messagebox.showinfo('Delete','Data Delete')
                db.commit()
                db.close() 
    ...
    def insreg():
        ...
        def emailotp():
              ...
              from_address = "ritikpachouri2004@gmail.com"
              ...
              msg.attach(part1)
               ...
               # Credentials
              username = 'ritikpachouri2004@gmail.com'  
              password = 'plyfxmbnpzkpqwmp'
...
#Canvas22
        ...
        mid_canvas21.place(x=205,y=110)
        
        #heading
        heading=Label(mid_canvas21,text='REGISTRATION INSERT',fg='green',bg='white',font=('arial',45,'bold'),width=45)
        heading.place(x=-160,y=10)
        ...
        button_otp=Button(mid_canvas21,width=5,pady=5,text='OTP',bg='#57a1f8',fg='white',border=0,command=emailotp)
        button_otp.place(x=1120,y=200)
...
#Canvas23
        ...
        mid_canvas22.place(x=205,y=110)
        
        #heading
        heading=Label(mid_canvas22,text='REGISTRATION UPDATE',fg='green',bg='white',font=('arial',45,'bold'),width=45)
        heading.place(x=-160,y=10)
        ...
        def updatedata():
            ...
            if len(p)==0 or len(r)==0 or len(t)==0 or len(s)==0 or len(v)==0 or len(w)==0 or len(x)==0 or len(z)==0 or len(b)==0 or len(c)==0:
                ...
                sql="update registration set name='%s',address='%s',city='%s',phone='%s',email='%s',course='%s',Batch_id='%s',feeplan_id='%s',dateofjoining='%s' where reg_no='%s'" %(r,t,s,v,w,x,z,b,c,p)
                cur.execute(sql)
                messagebox.showinfo('Update','Update Done')
                db.commit()    
                db.close()
...
#Canvas24
        ...
        mid_canvas23.place(x=205,y=110)
        
        #heading
        heading=Label(mid_canvas23,text='REGISTRATION FIND',fg='green',bg='white',font=('arial',45,'bold'),width=45)
        heading.place(x=-160,y=10)
...
#Canvas25
        ...
        mid_canvas24.place(x=205,y=110)
        
        #heading
        heading=Label(mid_canvas24,text='REGISTRATION DELETE',fg='green',bg='white',font=('arial',45,'bold'),width=45)
        heading.place(x=-160,y=10)
...
#Canvas26
         ...
         mid_canvas25.place(x=205,y=110)
            
            #heading
         heading=Label(mid_canvas25,text='COURSECOMPLETE INSERT',fg='green',bg='white',font=('arial',45,'bold'),width=45)
         heading.place(x=-160,y=10)
         regidlist=[]
         def savedata():
             db=pymysql.connect(host='localhost',user='root',password='Ritik@123',database='ERS')
...
#Canvas27
         ...
         mid_canvas26.place(x=205,y=110)
            
            #heading
         heading=Label(mid_canvas26,text='COURSECOMPLETE UPDATE',fg='green',bg='white',font=('arial',45,'bold'),width=45)
         heading.place(x=-160,y=10)
         ...
         def updatedata():
            ...
            if len(p)==0 or len(r)==0 or len(t)==0 or len(s)==0:
                ...
                sql="update coursecomplete set Batch_id='%s',cour_id='%s',date_of_complete='%s' where reg_no='%s'" %(r,t,s,p)
                cur.execute(sql)
                messagebox.showinfo('Update','Update Done')
                db.commit()    
                db.close()
...
#Canvas28
         ...
         mid_canvas27.place(x=205,y=110)
            
            #heading
         heading=Label(mid_canvas27,text='COURSECOMPLETE FIND',fg='green',bg='white',font=('arial',45,'bold'),width=45)
         heading.place(x=-160,y=10)
...
#Canvas29
         ...
         mid_canvas28.place(x=205,y=110)
            
            #heading
         heading=Label(mid_canvas28,text='COURSECOMPLETE DELETE',fg='green',bg='white',font=('arial',45,'bold'),width=45)
         heading.place(x=-160,y=10)
...
#Canvas30
         ...
         mid_canvas29.place(x=205,y=110)
            
            #heading
         heading=Label(mid_canvas29,text='CERTIFICATEISSUE INSERT',fg='green',bg='white',font=('arial',45,'bold'),width=45)
         heading.place(x=-160,y=10)
         regidlist=[]
         batchidlist=[]
         courselist=[]
...
#Canvas31
         ...
         mid_canvas30.place(x=205,y=110)
            
            #heading
         heading=Label(mid_canvas30,text='CERTIFICATEISSUE UPDATE',fg='green',bg='white',font=('arial',45,'bold'),width=45)
         heading.place(x=-160,y=10)
...
#Canvas32
         ...
         mid_canvas31.place(x=205,y=110)
            
            #heading
         heading=Label(mid_canvas31,text='CERTIFICATEISSUE FIND',fg='green',bg='white',font=('arial',45,'bold'),width=45)
         heading.place(x=-160,y=10)
...
#Canvas33
         ...
         mid_canvas32.place(x=205,y=110)
            
            #heading
         heading=Label(mid_canvas32,text='CERTIFICATEISSUE DELETE',fg='green',bg='white',font=('arial',45,'bold'),width=45)
         heading.place(x=-160,y=10)
...
#Canvas2
    Top_canvas=Canvas(t,width=1600,height=130,bg='green',border=-10)
    Top_canvas.place(x=210,y=0)
    
#Canvas
    first_canvas=Canvas(t,width=210,height=1600,bg="grey",border=-10)
    first_canvas.place(x=0,y=0)
    
    ers_label=Label(first_canvas,text='ERS!',font=('arial',50),bg="silver",fg="green")
    ers_label.place(x=10,y=80)
    
    button_reg=Button(first_canvas,width=23,font=5,text='REGISTRATION',bg='green',fg='white',border=0,command=reg)
    button_reg.place(x=-20,y=250)
    
            
    button_course=Button(first_canvas,width=23,font=5,text='COURSE',bg='green',fg='white',border=0,command=cour)
    button_course.place(x=-20,y=300)
            
    button_feeplan=Button(first_canvas,width=23,font=5,text='FEE PLANS',bg='green',fg='white',border=0,command=fee)
    button_feeplan.place(x=-20,y=350)
            
    button_enquiry=Button(first_canvas,width=23,font=5,text='ENQUIRY',bg='green',fg='white',border=0,command=enq)
    button_enquiry.place(x=-20,y=400)
   
    button_batch=Button(first_canvas,width=23,font=5,text='BATCH',bg='green',fg='white',border=0,command=batc)
    button_batch.place(x=-20,y=450)
    
    button_institute=Button(first_canvas,width=23,font=5,text='INSTITUTE',bg='green',fg='white',border=0,command=insr)
    button_institute.place(x=-10,y=500)
   
            
    button_com=Button(first_canvas,width=20,font=5,text='COURSE COMPLETE',bg='green',fg='white',border=0,command=corcom)
    button_com.place(x=-10,y=550)
            
    button_cer=Button(first_canvas,width=20,font=5,text='CERTIFICATE ISSUE',bg='green',fg='white',border=0,command=certissue)
    ...
    def logout():
         ...
         t.destroy()
    button_out=Button(first_canvas,width=20,font=5,text='LOG OUT',bg='green',fg='white',border=0,command=logout)
